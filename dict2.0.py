...
def W():
    ...
    Label(root, text="", width=20, font="comicansans 12 bold", height=2, bg="white").place(x=800, y=320)
def X():
    Label(root, text="", width=20, font="comicansans 12 bold", height=2, bg="pink",).place(x=800,y=80)
    Label(root, text="", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=120)
    Label(root, text="", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=160)
    Label(root, text="", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=240)
    Label(root, text="", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=280)
    Label(root, text="", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=320)
def Y():
